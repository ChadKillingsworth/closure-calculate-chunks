 ...
 */
export default async function generateHtml(chunkGraph) {
  const replacements = {
    ...
    'load_graph': JSON.stringify(convertGraph(chunkGraph.graph)),
    'dep_graph': JSON.stringify(convertGraph(chunkGraph.toDependencyGraph()))
  };
